  ...
  try {
    ...
    if (action === 'create' || action === 'update') {
      ...
      if (action === 'update' && documentId) {
        ...
        await fetch(`https://api.elevenlabs.io/v1/convai/knowledge-base/${documentId}`, {
          method: 'DELETE',
          headers: {
      ...
      // Create document from text content using the correct convai API endpoint
      ...
      // Delete document from ElevenLabs using the correct convai API endpoint
